...
// ---- todolist 기능 시작
// HTML Form 에서 REST method는 GET과 POST만 사용가능..
// AJAX를 사용하지 않기 때문에 GET과 POST만 사용하게됨...
// get - ejs뷰로 forwarding
// post - db와 연동해서 처리하는 data crud process 역할
// forward란, 실제 주소의 내용이 아닌 다른 파일 내용 표시?

const todoList = [
  { _id: 101, title: "todo1", done: false },
  { _id: 102, title: "todo2", done: false },
  { _id: 103, title: "todo3", done: false },
...
app.get("/todo/:id/detail", (req, res) => {
  // 목록 출력
  res.render("todoList/TodoDetail", {});
});

app.get("/todo/:id/modify", (req, res) => {
...
app.post("/todo/:id/detail", (req, res) => {
  // 저장
  res.send("/todo");
});
app.post("/todo/:id/modify", (req, res) => {
  // 저장
  res.send("/todo");
});
// 단일삭제를 get으로?
